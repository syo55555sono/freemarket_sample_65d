...
  validates :email, presence: true, uniquness: true, format: {with: VALID_EMAIL_REGEX, message: "Emailのフォーマットが不適切です"}
  validates :password, presence: true, length: {in: 7..128}, format: {with: VALID_PASSWORD_REGEX, message: "パスワードは英字と数字両方を含むパスワードを設定してください"}
